...
import ThankYouPage from "./components/SellSection/ThankYouPage";  // Import ThankYouPage
import ExploreCalgary from './components/NewsAndInsights/ExploreCalgary'; // Import ExploreCalgary
import InsightsPage from './components/NewsAndInsights/InsightsPage'; // Import InsightsPage
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/explore-calgary" element={<ExploreCalgary />} /> {/* Add new route */}
          <Route path="/insights" element={<InsightsPage />} /> {/* Add InsightsPage route */}
        </Routes>
      </div>
    </Router>
  );
