    ...
    return (
        <div className="insights-page-container">
            <header className="insights-header">
                <button className="back-home-button" onClick={handleBackHome}>Home</button>
                <h1>Calgary Real Estate Insights</h1>
                ...
                <label className="insights-switch">
                    ...
                    <span className="switch-label">Community Insights</span>
                </label>
            </header>
